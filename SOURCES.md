...
仍由同一佩麗卡官方原片製作，沒有剪輯動作或縮短內容。桌機 perlica-desktop-hq.mp4：RGB+alpha封裝2880×810、有效1440×810，H.264 Main Level5.0；手機 perlica-mobile-hq.mp4：封裝1920×540、有效960×540，Main Level3.2。均30fps、yuv420p、CRF18、Lanczos等比例縮放、faststart，時長3.10秒。更新後重製工具預設產生HQ檔，原先輕量素材保留，不改寫官方原片。
